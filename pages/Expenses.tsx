    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <Button onClick={() => setIsModalOpen(true)} icon="plus">Nuevo Gasto</Button>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card className="bg-red-50 border-red-100">
                    <p className="text-xs font-bold text-red-600 uppercase">Total Gastos (Mes)</p>
                    <p className="text-3xl font-black text-red-800">L {expenses.reduce((a, b) => a + b.amount, 0).toLocaleString()}</p>
                </Card>
            </div>
